  ...
  <main id="main" class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb small bg-transparent">
        ...
        <li class="breadcrumb-item text-dark font-weight-bold small active" aria-current="page">手机</li>
      </ol>
    </nav>
      ...
      <div class="row pr-3">
        <div id="preview" class="col pr-0">
          <div class="card bg-transparent mr-5 position-absolute">
            <img id="img-md" class="card-img-top" :src="`${pics[i].md}`" alt="Card image cap" />
            ...
            <div class="card-body p-0 text-center">
              ...
              <div class="d-inline-block pt-2 mx-0 m-auto" style="width: 248px; overflow:hidden;">
                ...
                >
                  <li v-for="(p, i) of pics" :key="i" class="float-left p-1">
                    <img :src="`${p.sm}`" @mouseover="changei(i)" />
          ...
          <li class="float-left">
            <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
              ...
              <div class="card-body p-0">
                <p class="card-text text-center small">小米11</p>
              </div>
            </div>
          </li>
      ...
      <div class="row mr-1">
        <div class="col-md-10 pt-5">
          ...
          <div class="pl-3">
            <ul class="list-unstyled">
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">商品名称：小米11</a>
              </li>

              <li class="float-left mb-2">
                <a class="text-muted small" href="#">系统：MIUI 12</a>
              </li>

              <li class="float-left mb-2">
                <a class="text-muted small" href="#">内存容量：16G</a>
              </li>

              <li class="float-left mb-2">
                <a class="text-muted small" href="#">分辨率：2480*1860</a>
              </li>

              <li class="float-left mb-2">
                <a class="text-muted small" href="#">显卡型号：高通骁龙888</a>
              </li>

              <li class="float-left mb-2">
                <a class="text-muted small" href="#">处理器：高通骁龙888</a>
              </li>
              ...
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">分类：手机</a>
              </li>

              <li class="float-left mb-2">
                <a class="text-muted small" href="#">容量:128G固态</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            <div>
              <div>
                <img alt src="/img/product/detail/57b1561N81dc489d.jpg" />
              </div>
            </div>
          ...
          <div class="pl-3">
            <div>
              ...
              <p class="small">手机专卖店向您保证所售商品均为正品行货，达内自营商品开具机打发票或电子发票。</p>
          ...
          <div class="pl-3">
            <p class="small">
              手机 x1 充电头 x1 数据线 x1 说明书（电子版）x1
              备注：手机的背面只会标注此手机的系列，例如： 小米 11
            </p>
          </div>
        </div>
        ...
        <div class="col-md-2 mb-4 pt-5 pl-2">
          <a class="btn p-3 pl-4 pr-4 mb-2" href="#规格参数">
            <h5 class="text-dark mb-0">
              <img src="/img/product_detail/product_detail_icon_g_1.png" alt />
          ...
          <a class="btn p-3 pl-4 pr-4 mb-2" href="#商品介绍">
            <h5 class="text-dark mb-0k">
              <img src="/img/product_detail/product_detail_icon_t_1.png" alt />
          ...
          <a class="btn p-3 pl-4 pr-4 mb-2" href="#售后保障">
            <h5 class="text-dark mb-0">
              <img src="/img/product_detail/product_detail_icon_d_1.png" alt />
          ...
          <a class="btn p-3 pl-4 pr-4 mb-2" href="#包装清单">
            <h5 class="text-dark mb-0">
              <img src="/img/product_detail/product_detail_icon_bao_1.png" alt />
          ...
          <a class="btn p-3 pl-4 pr-4 mb-2" href="#header">
            <h5 class="text-dark mb-0">
              <img src="/img/product_detail/product_detail_icon_up_1.png" alt />
